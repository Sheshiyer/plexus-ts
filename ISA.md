...
- Workflow syntax: actionlint `v1.7.7`, Ruby YAML parsing, and the 18-test release workflow contract all passed the pinned CI, exact-main manual candidate, and Publish OTA workflows.
