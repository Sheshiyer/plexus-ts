...
|---|---|---|---|
| Batch 10 | P2-W2-T011, P2-W2-T012, P2-W2-T013, P2-W2-T014 | Move Fabric task cache/history from settings JSON toward queryable member-scoped records. | Fabric task persistence tests, ownership tests, and bridge smoke. |
