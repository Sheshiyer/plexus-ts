...
|---|---|---|---|
| Batch 9 | P2-W1-T006, P2-W1-T007, P2-W1-T008, P2-W1-T009, P2-W1-T010 | Move from safe action execution into evidence/report custody: report draft, evidence attachment, bridge fallback, and failure state proof. | Assistant/evidence tests, bridge smoke, and report handoff docs. |
| Batch 10 | P3-W1-T001, P3-W1-T002, P3-W1-T003, P3-W1-T004 | Start the employee Today first-viewport slice after the assistant action loop is durable. | Today model tests, renderer build, and screenshot proof. |
| Batch 11 | P4-W1-T001, P4-W1-T002, P4-W1-T003, P4-W1-T004 | Begin founder/admin proof cockpit once employee action and evidence paths have stable data. | Cockpit model tests, screenshot matrix, and docs sync. |
