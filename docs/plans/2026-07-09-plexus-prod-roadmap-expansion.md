...
|---|---|---|---|
| Batch 13 | P2-W2-T015, P2-W2-T016, P2-W2-T017, P2-W2-T018, P2-W2-T019 | Continue the evidence spine after queryable Fabric records by adding provenance, report task proof, generated proof packet retrieval, and Worker-first/bridge-fallback delivery state. | Evidence provenance tests, report proof tests, daily packet retrieval tests, and bridge fallback smoke. |
| Batch 14 | P3-W1-T005, P3-W1-T006, P3-W1-T007, P3-W1-T008, P3-W1-T009 | Continue Clio Today from the route/model foundation into complete assignment, room, runtime, and recommendation mappings. | Today aggregate tests, first-viewport screenshots, and copy/overflow guards. |
| Batch 15 | P4-W1-T005, P4-W1-T006, P4-W1-T007, P4-W1-T008 | Continue the founder proof cockpit from typed shell and task/evidence counts into room, report, bridge, Fabric, Hermes, and release health signals. | Cockpit model tests, degraded/manual source-health tests, screenshot matrix, and docs sync. |
