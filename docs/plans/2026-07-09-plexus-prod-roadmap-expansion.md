...
|---|---|---|---|
| Batch 12 | P4-W1-T001, P4-W1-T002, P4-W1-T003, P4-W1-T004 | Begin founder/admin proof cockpit once employee action and evidence paths have stable data. | Cockpit model tests, screenshot matrix, and docs sync. |
