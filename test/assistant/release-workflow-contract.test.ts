...
describe('release workflow publication contract', () => {
  ...
  it('pins every first-party action to an immutable commit and enables update automation', () => {
    ...
    expect(workflows).toContain('actions/checkout@3d3c42e5aac5ba805825da76410c181273ba90b1 # v7.0.1');
    expect(workflows).toContain('actions/setup-node@820762786026740c76f36085b0efc47a31fe5020 # v7.0.0');
